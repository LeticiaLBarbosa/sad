...
// Criando a v√°riavel QqidQuestao que leva a referencia de qid para a consulta sql3 que separa as resposta de cada quest√£o
...
// Consulta para exibir as quest√µes
...
// Codigo abaixo Pega todas as quest√µes
...
for($i = 0; $i < 14; $i ++) {
	...
	if($i < 13){
		...
		echo utf8_encode ("<b>MÈdia do DSC: </b>").  $arrayMediasQuesito[$i]  . " || " .  utf8_encode ("<b>Sua MÈdia: </b>") . media($ValorRespostas);
	}
