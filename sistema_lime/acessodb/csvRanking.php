...
for ($i = 1; $i < count($matriz) - 2; $i++) {
	...
	for ($i = 0; $i < count($matrizDisc[0]);$i++) {
        ...
        fwrite($fileCSV, ("desvioPositivo" . "," . round((media(arrayColunaDaMatriz($matrizDisc,$i))+desvioPadrao(arrayColunaDaMatriz($matrizDisc,$i))),2) . "," . "Q".($i+1) . "," . 0 . "\n"));
        fwrite($fileCSV, ("desvioNegativo" . "," . round((media(arrayColunaDaMatriz($matrizDisc,$i))-desvioPadrao(arrayColunaDaMatriz($matrizDisc,$i))),2) . "," . "Q".($i+1) . "," . 0 . "\n"));
