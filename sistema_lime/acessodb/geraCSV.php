<?php
	...
	$disciplina_id ="287555";
	
	$nomeProfessor = "";
	$nomeDisciplina = "ProgramaÃÃo II(Turma 1 - 2013.2)";
	$linhaMontada = "" . $nomeProfessor . "," . $nomeDisciplina . ",";
	...
	for($i = 0; $i < 13; $i ++) {
		...
		$indiceArrayTituloRespostas = 0;
		// Laco que anda pelas linhas contando a quantidade de respostas while ($row3 = mysql_fetch_array($res3) ){
...
function media($respostas) {
	...
	return array_sum ( $respostas ) / $totalRespostas;
}
