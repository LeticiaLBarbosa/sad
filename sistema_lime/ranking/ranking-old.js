...
questao_avaliada = p; //livia: guarda o identificador da questao escolhida
    ...
    if (val_per.length<2) {
        ...
        // Imprime a disciplina escolhida
        svg.append("text")
            .attr("y", h1-50)
            .attr("x", 20)
            .attr("text-anchor", "center")
        ...
        svg.append("text")
            ...
            .attr("font-size", "12px")
            .attr("font-weight", "bold")
            .text("Questao avaliada:");
        svg.append("text")
            .attr("y", h1-38)
            .attr("x", 125)
            .attr("text-anchor", "center")
            .attr("font-size", "12px")
            .text(questao_avaliada);
            
        // Imprime a quantidade de disciplinas avaliadas na questao escolhida
        svg.append("text")
            .attr("y", h1-26)
            .attr("x", 20)
            .attr("text-anchor", "center")
        ...
        svg.append("text")
            ...
            .attr("font-size", "12px")
            //.attr("font-weight", "bold")
            .text(val_per.length + " disciplinas");
